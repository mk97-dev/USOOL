...
public class RCC_MobileButtons : MonoBehaviour {
	...
	void Update(){
        ...
        //gasInput = GetInput (gasButton);             //ForCheckingBluetoothController
        //brakeInput = GetInput(brakeButton);
        //leftInput = GetInput(leftButton);
        //rightInput = GetInput(rightButton);

		gasInput = Input.GetAxis("right");             //ForCheckingBluetoothController
		brakeInput = Input.GetAxis("left");
		leftInput = Input.GetAxis("accelerator");
		rightInput = Input.GetAxis("brake");

		//gasInput = Input.GetAxis("accelerator");             //ForCheckingBluetoothController
